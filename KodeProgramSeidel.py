...
def solve_with_seidel(initial_x, initial_y, tolerance=1e-6, max_iterations=100):
    """
    Menemukan solusi sistem persamaan non-linear menggunakan metode Gauss-Seidel.
    """
    x = initial_x
    y = initial_y
